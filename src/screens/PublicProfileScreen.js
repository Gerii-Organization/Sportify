...
import { 
  ...
  Flame, Trophy, Activity, Crown, User, TrendingUp 
...
export default function PublicProfileScreen({ route, navigation }) {
  ...
  let textStyle = styles.actionBtnTextPrimary;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            <Trophy color="#FFD700" size={28} fill="rgba(255, 215, 0, 0.2)" />
          ...
          <View style={styles.statBox}>
            ...
            <Text style={styles.statValue}>{profile.workouts_per_week || 0}</Text>
            ...
            recentWorkouts.map((w, idx) => (
              <View key={w.id || idx} style={styles.recentItem}>
                <View style={styles.recentIconBox}>
                  <TrendingUp color={NEON_GREEN} size={20} />
                </View>
                <View style={{ flex: 1 }}>
